    ...
    >
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        <div
          style={{
            ...
            height: 400,
            borderRadius: '50%',
            background: `radial-gradient(circle, color-mix(in srgb, ${event.accent} 18%, transparent), transparent 70%)`,
          }}
        />
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, color-mix(in srgb, var(--plum) 10%, transparent), transparent 70%)',
          }}
        />
      </div>
      ...
      >
        ...
        <div className='anim-up' style={{ marginTop: 40, marginBottom: 32 }}>
          ...
          <h1
            className='display'
            style={{ fontSize: 38, lineHeight: 1.1, marginBottom: 16 }}
          >
            {event.name}
          </h1>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p className='lead' style={{ fontSize: 14, lineHeight: 1.5 }}>
                Tell us about yourself in 2 minutes. The AI reads everyone in
                the room and finds your 3 best connections tonight.
              </p>
            </div>
          </div>
          ...
          <button
            ...
            onClick={() => router.push(`/event/${event.slug}/join`)}
            style={{
              background: event.accent,
              boxShadow: `0 8px 22px color-mix(in srgb, ${event.accent} 38%, transparent)`,
            }}
          >
            ...
            {detailsOpen && (
              ...
              >
                ...
                >
                  <p
                    className='lead'
                    style={{ fontSize: 14.5, lineHeight: 1.6, marginTop: 16 }}
                  >
                    {event.about}
                  </p>
                  <div
